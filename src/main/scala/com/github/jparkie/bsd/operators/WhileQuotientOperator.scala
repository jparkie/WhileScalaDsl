...
case class WhileQuotientOperator(leftArgument: WhileNumberType, rightArgument: WhileNumberType) extends WhileNumberType {
   override def nodeName: String = classOf[WhileQuotientOperator].getSimpleName
