...
case class WhileLesserThanEqualOperator(leftArgument: WhileNumberType, rightArgument: WhileNumberType) extends WhileBooleanType {
  override def nodeName: String = classOf[WhileLesserThanEqualOperator].getSimpleName
