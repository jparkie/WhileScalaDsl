...
case class WhileDifferenceOperator(leftArgument: WhileNumberType, rightArgument: WhileNumberType) extends WhileNumberType {
   override def nodeName: String = classOf[WhileDifferenceOperator].getSimpleName
