...
case class WhileGreaterThanEqualOperator(leftArgument: WhileNumberType, rightArgument: WhileNumberType) extends WhileBooleanType {
  override def nodeName: String = classOf[WhileGreaterThanEqualOperator].getSimpleName
