...
case class WhileSumOperator(leftArgument: WhileNumberType, rightArgument: WhileNumberType) extends WhileNumberType {
   override def nodeName: String = classOf[WhileSumOperator].getSimpleName
