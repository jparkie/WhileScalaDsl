...
case class WhileProductOperator(leftArgument: WhileNumberType, rightArgument: WhileNumberType) extends WhileNumberType {
   override def nodeName: String = classOf[WhileProductOperator].getSimpleName
