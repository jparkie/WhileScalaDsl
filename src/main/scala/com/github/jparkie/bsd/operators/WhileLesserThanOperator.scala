...
case class WhileLesserThanOperator(leftArgument: WhileNumberType, rightArgument: WhileNumberType) extends WhileBooleanType {
  override def nodeName: String = classOf[WhileLesserThanOperator].getSimpleName
