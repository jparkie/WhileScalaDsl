...
case class WhileEqualOperator(leftArgument: WhileNumberType, rightArgument: WhileNumberType) extends WhileBooleanType {
  require(leftArgument.isInstanceOf[WhileBooleanType] || leftArgument.isInstanceOf[WhileNumberType])
  require(rightArgument.isInstanceOf[WhileBooleanType] || rightArgument.isInstanceOf[WhileNumberType])

  override def nodeName: String = classOf[WhileEqualOperator].getSimpleName
