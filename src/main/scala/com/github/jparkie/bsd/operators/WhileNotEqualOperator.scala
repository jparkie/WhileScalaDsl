...
case class WhileNotEqualOperator(leftArgument: WhileNumberType, rightArgument: WhileNumberType) extends WhileBooleanType {
  override def nodeName: String = classOf[WhileNotEqualOperator].getSimpleName
